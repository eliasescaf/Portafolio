        ...
        <header className="fixed top-0 w-full z-50 border-b border-zinc-800 hover:border-emerald-500 transition-colors duration-300 bg-zinc-950/80 backdrop-blur-md">
            <div className="w-[90%] mx-auto px-6 h-16 flex items-center justify-between">
                ...
                <menu className="flex gap-6">
                    <Link href="/" className="text-zinc-400 py-2 font-medium text-sm hover:text-zinc-100 border-b border-zinc-950/80 hover:border-zinc-100 transition-colors">
                        HOME
                    </Link>
                    <Link href="/blog" className="text-zinc-400 py-2 font-medium text-sm hover:text-zinc-100 border-b border-zinc-950/80 hover:border-zinc-100 transition-colors">
                        BLOG
                    </Link>
                </menu>
            </div>    
